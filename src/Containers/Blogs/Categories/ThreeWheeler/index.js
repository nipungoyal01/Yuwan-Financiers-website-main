        ...
        <Container>
          <Row>
            <Col>
              ...
              {ThreeWheelerData.data.map((item,id)=>{
                return (
                  <Link to={`/blogs/three-wheeler-loan/${item.url}`}>
                  <ServiceGrids 
                  key={id}
...
export default BlogThreewheeler;
