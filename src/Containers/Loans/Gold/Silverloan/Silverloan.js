...
const Silver = (props) => {
  ...
  return (
    <>
      ...
      title="Overview"
      eventKey="1"
      OverviewHeading="Yuwan Finance Silver Loan Details"
      OverViewsubHeading="Know all about Silver Loan offerings"
      ...
      professionals like Chartered Accountants, Company Secretaries and
                    ...
                    OverviewHeading1="Why choose Yuwan Finance Silver Loan?"
                    ...
                    Bulletp4="Competitive professional loan interest rates"
                      ...
                      />
                        ...
                        eventKey="2"
                        FeatureHeading="Features & Benefits of a Silver Loan"
                    ...
                    eventKey="3"
                    ElegibilityHeading="Silver Loan Eligibility & Documents"
                    ...
                    DocumentHeading1="Documents Required For Silver Loan"
                  ...
                  eventKey="4"
                 ChargesHeading="Silver Loan Interest Rate & Charges"
          ...
          <Row>
            <Col className="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 ">
              <div className="testimonial-heading">
                <h2>What our Clients says about our Silver Loans!!</h2>
              </div>
            </Col>
          </Row>
          <Row>
