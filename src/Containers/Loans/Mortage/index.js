  ...
  return (
    <>
      ...
      professionals like Chartered Accountants, Company Secretaries and
                    ...
                    eventKey="3"
                    ElegibilityHeading="Mortage Loan Eligibility & Documents"
                    ...
                    DocumentHeading1="Documents Required For Mortage Loan"
                  ...
                  eventKey="4"
                 ChargesHeading="Mortage Loan Interest Rate & Charges"
          ...
          <Row>
            <Col className="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 ">
              <div className="testimonial-heading">
                <h2>What our Clients says about our Mortage Loans!!</h2>
              </div>
            </Col>
          </Row>
          <Row>
