...
const Electric = (props) => {
  ...
  return (
    <>
      ...
      title="Overview"
      eventKey="1"
      OverviewHeading="Yuwan Finance Electric Vehicle Loan Details"
      OverViewsubHeading="Know all about Electric Vehicle Loan offerings"
      ...
      professionals like Chartered Accountants, Company Secretaries and
                    ...
                    OverviewHeading1="Why choose Yuwan Finance Electric Vehicle Loan?"
                    ...
                    Bulletp4="Competitive professional loan interest rates"
                      ...
                      />
                        ...
                        eventKey="2"
                        FeatureHeading="Features & Benefits of a Electric Vehicle Loan"
                    ...
                    eventKey="3"
                    ElegibilityHeading="Electric Vehicle Loan Eligibility & Documents"
                    ...
                    DocumentHeading1="Documents Required For Electric Vehicle Loan"
                  ...
                  eventKey="4"
                 ChargesHeading="Electric Vehicle Loan Interest Rate & Charges"
          ...
          <Row>
            <Col className="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 ">
              <div className="testimonial-heading">
                <h2>What our Clients says about our Electric Vehicle Loans!!</h2>
              </div>
            </Col>
          </Row>
          <Row>
