...
const FourWheeler = (props) => {
  ...
  return (
    <>
      ...
      title="Overview"
      eventKey="1"
      OverviewHeading="Yuwan Finance Four Wheeler Loan Details"
      OverViewsubHeading="Know all about Four Wheeler Loan offerings"
      ...
      professionals like Chartered Accountants, Company Secretaries and
                    ...
                    OverviewHeading1="Why choose Yuwan Finance Four Wheeler Loan?"
                    ...
                    Bulletp4="Competitive professional loan interest rates"
                      ...
                      />
                        ...
                        eventKey="2"
                        FeatureHeading="Features & Benefits of a Four Wheeler Loan"
                    ...
                    eventKey="3"
                    ElegibilityHeading="Four Wheeler Loan Eligibility & Documents"
                    ...
                    DocumentHeading1="Documents Required For Four Wheeler Loan"
                  ...
                  eventKey="4"
                 ChargesHeading="Four Wheeler Loan Interest Rate & Charges"
          ...
          <Row>
            <Col className="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 ">
              <div className="testimonial-heading">
                <h2>What our Clients says about our Four wheeler Loans!!</h2>
              </div>
            </Col>
          </Row>
          <Row>
