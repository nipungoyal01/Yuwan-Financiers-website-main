...
const Heavy = (props) => {
  ...
  return (
    <>
      ...
      title="Overview"
      eventKey="1"
      OverviewHeading="Yuwan Finance Heavy Vehicle Loan Details"
      OverViewsubHeading="Know all about Heavy Vehicle Loan offerings"
      ...
      professionals like Chartered Accountants, Company Secretaries and
                    ...
                    OverviewHeading1="Why choose Yuwan Finance Heavy Vehicle Loan?"
                    ...
                    Bulletp4="Competitive professional loan interest rates"
                      ...
                      />
                        ...
                        eventKey="2"
                        FeatureHeading="Features & Benefits of a Heavy Vehicle Loan"
                    ...
                    eventKey="3"
                    ElegibilityHeading="Heavy Vehicle Loan Eligibility & Documents"
                    ...
                    DocumentHeading1="Documents Required For Heavy Vehicle Loan"
                    DocumentRequirement1="PAN Card / Aadhaar Card."
                    DocumentRequirement2="Heavyity Bill / Rent Agreement / Passport."
                  ...
                  eventKey="4"
                 ChargesHeading="Heavy Vehicle Loan Interest Rate & Charges"
          ...
          <Row>
            <Col className="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 ">
              <div className="testimonial-heading">
                <h2>What our Clients says about our Heavy Vehicle Loans!!</h2>
              </div>
            </Col>
          </Row>
          <Row>
        ...
        <Container>
          <Row>
            <Col>
              <div className="feature-grids clearfix">
          <Slider {...settings}>
          <Link to="/twowheeler"><ServiceGrids imageclass="image" image_imgclass="image__img" contentclass="image__overlay" nameclass="image__title" descriptionclass="image__description" img={Two_wheeler} alt="Two Wheeler" name="Two Wheeler"/></Link> 
