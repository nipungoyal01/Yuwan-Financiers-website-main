...
import "../Vehicle.css";
import "../TwoWheeler/TwoWheeler.css";
...
import three_wheeler_banner from "../../../../img/three_wheeler_banner.png"
...
const ThreeWheeler = (props) => {
  ...
  return (
    <>
      ...
      title="Overview"
      eventKey="1"
      OverviewHeading="Yuwan Finance Three Wheeler Loan Details"
      OverViewsubHeading="Know all about Three Wheeler Loan offerings"
      ...
      professionals like Chartered Accountants, Company Secretaries and
                    ...
                    OverviewHeading1="Why choose Yuwan Finance Three Wheeler Loan?"
                    ...
                    Bulletp4="Competitive professional loan interest rates"
                      ...
                      />
                        ...
                        eventKey="2"
                        FeatureHeading="Features & Benefits of a Three Wheeler Loan"
                    ...
                    eventKey="3"
                    ElegibilityHeading="Three Wheeler Loan Eligibility & Documents"
                    ...
                    DocumentHeading1="Documents Required For Three Wheeler Loan"
                  ...
                  eventKey="4"
                 ChargesHeading="Three Wheeler Loan Interest Rate & Charges"
          ...
          <Row>
            <Col className="col-lg-6 offset-lg-3 col-md-8 offset-md-2 col-sm-10 offset-sm-1 ">
              <div className="testimonial-heading">
                <h2>What our Clients says about our Three wheeler Loans!!</h2>
              </div>
            </Col>
          </Row>
          <Row>
        ...
        <Container>
          <Row>
            <Col>
              <div className="feature-grids clearfix">
          <Slider {...settings}>
          <Link to="/threewheeler"><ServiceGrids imageclass="image" image_imgclass="image__img" contentclass="image__overlay" nameclass="image__title" descriptionclass="image__description" img={Two_wheeler} alt="Two Wheeler" name="Two Wheeler"/></Link> 
        ...
        <Container>
          <Row>
            <Col>
              <div className="feature-grids clearfix">
          <Slider {...settings}>
          <Link to="/twowheeler"><ServiceGrids imageclass="image" image_imgclass="image__img" contentclass="image__overlay" nameclass="image__title" descriptionclass="image__description" img={Four_wheeler} alt="Mortage Loan" name="Mortage Loan"/></Link> 
